# This Makefile is for the ThreatDetector extension to perl.
#
...
#     ABSTRACT => q[Modular Apache Log Threat Detection for Vicidial]
#     AUTHOR => [q[Jason Hall <jason.kei.hall@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[bin/detect.pl]]
#     LICENSE => q[perl]
#     META_MERGE => { resources=>{ repository=>q[https://github.com/Jkhall81/apache-threat-detector] } }
...
TO_INST_PM = lib/ThreatDetector/Classifier.pm \
...
ThreatDetector.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"ThreatDetector\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
pure_all :: $(INST_SCRIPT)\detect.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)\detect.pl 

$(INST_SCRIPT)\detect.pl : bin/detect.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)\detect.pl
	$(CP) bin/detect.pl $(INST_SCRIPT)\detect.pl
	$(FIXIN) $(INST_SCRIPT)\detect.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)\detect.pl
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Modular Apache Log Threat Detection for Vicidial'" >> META_new.yml
	$(NOECHO) $(ECHO) author: >> META_new.yml
	$(NOECHO) $(ECHO) "  - 'Jason Hall <jason.kei.hall@gmail.com>'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: ThreatDetector" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "  IPC::System::Simple: '0'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Modular Apache Log Threat Detection for Vicidial\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"Jason Hall ^<jason.kei.hall^@gmail.com^>\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"ThreatDetector\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "            \"IO::Scalar\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"IPC::System::Simple\" : \"0\"," >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"ThreatDetector\" VERSION=\"0.04\">" > ThreatDetector.ppd
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"File::Slurp\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"IO::Scalar\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"IPC::System::Simple\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"JSON::\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"URI::Escape\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.40\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> ThreatDetector.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> ThreatDetector.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/ThreatDetector/Classifier.pm blib\lib\ThreatDetector\Classifier.pm \
	  lib/ThreatDetector/Dispatcher.pm blib\lib\ThreatDetector\Dispatcher.pm \
	  lib/ThreatDetector/Handlers/BotFingerprint.pm blib\lib\ThreatDetector\Handlers\BotFingerprint.pm \
	  lib/ThreatDetector/Handlers/ClientError.pm blib\lib\ThreatDetector\Handlers\ClientError.pm \
	  lib/ThreatDetector/Handlers/CommandInjection.pm blib\lib\ThreatDetector\Handlers\CommandInjection.pm \
	  lib/ThreatDetector/Handlers/DirectoryTraversal.pm blib\lib\ThreatDetector\Handlers\DirectoryTraversal.pm \
	  lib/ThreatDetector/Handlers/EncodedPayload.pm blib\lib\ThreatDetector\Handlers\EncodedPayload.pm \
	  lib/ThreatDetector/Handlers/HeaderAbuse.pm blib\lib\ThreatDetector\Handlers\HeaderAbuse.pm \
	  lib/ThreatDetector/Handlers/LoginBruteForce.pm blib\lib\ThreatDetector\Handlers\LoginBruteForce.pm \
	  lib/ThreatDetector/Handlers/MethodAbuse.pm blib\lib\ThreatDetector\Handlers\MethodAbuse.pm \
	  lib/ThreatDetector/Handlers/RateLimiter.pm blib\lib\ThreatDetector\Handlers\RateLimiter.pm \
	  lib/ThreatDetector/Handlers/SQLInjection.pm blib\lib\ThreatDetector\Handlers\SQLInjection.pm \
